  ...
  ({ className, type, ...props }, ref) => (
    <input
      ...
      className={cn(
        ...
        "placeholder:text-neutral-400 dark:placeholder:text-[#787b86]",
        ...
        "disabled:cursor-not-allowed disabled:bg-neutral-50 disabled:text-neutral-400 dark:disabled:bg-[#131722] dark:disabled:text-[#787b86]",
